...
for ADV in "MPDATA" #"UM5" "SELPPM"
  ...
  for RAD in "RRTM" "CAM" "RRTM4PBL"
    ...
    for MICRO in "M2005" "THOM" "SAM1MOM" "DRIZZLE" "M2005_PA"
      ...
      ./Build &> log_build_2d_${MICRO}_${RAD}_${ADV} # build new executable
      if [[ -x SAM_ADV_${ADV}_SGS_TKE_RAD_${RAD}_MICRO_${MICRO} ]]
      then
	  echo "SAM compiled successfully"
      else
	  exit 9
      fi
	...
	grep "Finished with SAM" log_run_2d_${CASE}_${MICRO}_${RAD}_${ADV}
