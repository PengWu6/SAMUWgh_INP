module micro_params
  ...
  logical, public :: &
       ...
       donudging_aerosol = .false., &! enable nudging of prognostic aerosol using same nudging timescale as for moisture.
  ...
  real, public :: &
       ...
       massfactor = 1. ! scaling factor for aerosol mass -- large values (1e8?) may help flux correction schemes that struggle with small values (<1e-10)
